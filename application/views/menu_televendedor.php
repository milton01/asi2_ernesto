		...
		<div class="wrapper">
				...
				<div class="top-navbar-inner">
					...
					<div class="top-nav-content">
						...
						<ul class="nav-user navbar-right">
                                                    <img src="<?=base_url()?>assets/img/avatar/avatar-11.jpg" />
                                                    Bienvenid@, <strong>Miguel FLores</strong>
							<li class="dropdown">
			...
			<div class="sidebar-left sidebar-nicescroller">
				<ul class="sidebar-menu">
                                    ...
                                    <li>
					<?php echo anchor('pedido', 'Registro de pedido');?>                                        
                                        <ul class="submenu visible">
                                            <?php echo anchor('pedido', 'Mostrar detalle de pedido');?>
                                        </ul>
                                    </li>                               
                                    <li>
					<?php echo anchor('pedido', 'Agregar nuevo cliente');?>
                                    </li>
                                    <li class="inactive">
