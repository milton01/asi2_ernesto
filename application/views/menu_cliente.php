				...
				<div class="top-navbar-inner">
					...
					<div class="top-nav-content">
						...
						<ul class="nav-user navbar-right">
                                                    <img src="<?=base_url()?>assets/img/avatar/avatar-10.jpg" />
                                                    Bienvenid@, <strong>Jorge Altuve</strong>
							<li class="dropdown">
			...
			<div class="sidebar-left sidebar-nicescroller">
				<ul class="sidebar-menu">
					...
					<?php echo anchor('master', 'Carrito de compras');?>
                                    ...
                                    <li>
					<?php echo anchor('pedido', 'Mis pedidos');?>
                                    </li>
                                    <li class="inactive">
                                            <?php echo anchor('pedido', 'Estado de saldos........>');?>
                                        <ul class="submenu visible">
                                            <li><?php echo anchor('ruta', 'Estado crediticio');?></li>
                                            <li><?php echo anchor('ruta', 'Facturas pendientes');?></li>
                                        </ul>
                                    </li>
      </ul>
    </div><!-- leftpanelinner -->
